...
exports.default = sendVerificationOTP;
const env_1 = require("../../config/env");
const mailer_1 = require("../../config/mailer");
async function sendVerificationOTP(userEmail, otp) {
    try {
        const info = await mailer_1.mailer.sendMail({
            from: `"facedict" <${env_1.SMTP_USER}>`,
            to: userEmail,
