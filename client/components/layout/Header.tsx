...
export default function Header({ avater }: { avater: string }) {
  const pathName = usePathname();

  return (
    <header className='flex flex-row flex-wrap justify-between items-center gap-y-2 h-auto min-h-14 px-3 sm:px-5 py-2 shadow-md'>
      ...
      <Avatar>
        <AvatarImage src={avater} alt='profile Image' height={50} width={50} className={'w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 rounded-full shrink-0'} />
